...
--
-- Dumping events for database 'LoveCode'
--
...
--
--
-- WARNING: can't read the INFORMATION_SCHEMA.libraries table. It's most probably an old server 11.8.3-MariaDB-0+deb13u1 from Debian.
--
--
-- WARNING: can't read the INFORMATION_SCHEMA.libraries table. It's most probably an old server 11.8.3-MariaDB-0+deb13u1 from Debian.
--
...
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `Borrar_Usuario`(IN p_id_usuario INT)
BEGIN
...
-- WARNING: can't read the INFORMATION_SCHEMA.libraries table. It's most probably an old server 11.8.3-MariaDB-0+deb13u1 from Debian.
--
/*!50003 DROP PROCEDURE IF EXISTS `ver_usuario` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `ver_usuario`()
begin
	select * from usuario;
end ;;
DELIMITER ;
...
-- Dump completed on 2026-05-15 11:38:26
